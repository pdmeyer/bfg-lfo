...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.5, 364.0, 150.0, 52.0 ],
					"text" : "double-click for more info on BFG, bases, etc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 540.5, 418.0, 86.0, 22.0 ],
					"text" : "jit.bfg.maxhelp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.5, 120.0, 360.0, 221.0 ],
					"presentation_linecount" : 30,
					"text" : "On: pretty self-explanatory\n\nClock Rate: Rate of the underlying metro that is generating the signal. higher values will result in a more \"stepped\" function, lower values are more smooth but will tax the CPU more\n\nSpeed: \"Frequency\" of of the signal. \n\nScale: Signal multiplier. For some bases, you will want to set this to a value closer to 0.\n\nBasis: The LFO \"shape\"\n\nInner, Outer, Filter, etc.: Params specific to certain bases. When you select a basis, the non-applicable params will be greyed out. See jit.bfg.maxhelp for more info!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.5, 96.0, 168.0, 22.0 ],
					"text" : "PARAMS"
				}
...
,
					"patching_rect" : [ 348.0, 14.0, 56.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 9.0, 206.0, 27.0 ],
					"text" : "BFG LFO"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-3::obj-113" : [ "noizeDistance[0]", "noizeDistance[0]", 0 ],
			"obj-3::obj-136" : [ "noizeOuter[0]", "noizeOuter[0]", 0 ],
			"obj-3::obj-137" : [ "noizeInner[0]", "noizeInner[0]", 0 ],
			"obj-3::obj-43" : [ "bfg_scale[0]", "bfg_scale[0]", 0 ],
			"obj-3::obj-59" : [ "noizeClkRate[0]", "number[18]", 0 ],
			"obj-3::obj-63" : [ "noizeEnable[0]", "noizeEnable[0]", 0 ],
			"obj-3::obj-66" : [ "noizeBasis[0]", "noizeBasis[0]", 0 ],
			"obj-3::obj-67" : [ "noizeFractBasis[0]", "noizeFractBasis[0]", 0 ],
			"obj-3::obj-68" : [ "noizeDetail[0]", "noizeDetail[0]", 0 ],
			"obj-3::obj-69" : [ "noizeLacun[0]", "noizeLacun[0]", 0 ],
			"obj-3::obj-78" : [ "noizeInc[0]", "number[17]", 0 ],
			"obj-3::obj-96" : [ "noizeFilter[0]", "noizeFilter[0]", 0 ],
			"parameterbanks" : 			{
